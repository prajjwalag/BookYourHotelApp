  ...
  return (
    <div className="bg-secondary">
      ...
      <div className="bg-brand">
        <div className='flex flex-col flex-wrap justify-center gap-4 p-4 mx-auto sm:flex-row sm:justify-between max-w-7xl'>
          <div className='flex items-center justify-center gap-4'>
            {SOCIAL_LINKS.map((link, index) => (
              <a href={link.href} key={index}>
                <Icon icon={link.icon} size={18} className="text-slate-100 hover:text-slate-300 transition-colors"></Icon>
              </a>
            ))}
          </div>
          <div>
