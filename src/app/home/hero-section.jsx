  ...
  return (
    <section className='relative min-h-[372px] bg-black'>
        <img 
            ...
            alt="A Mountain View with a very beautiful spot for picnic." />
        <div className="z-[2] relative container space-y-2">
            ...
            <Button className="cursor-pointer mt-6 h-12 px-4 text-base font-semibold">Discover Holiday Rentals</Button>
        </div>
    </section>
  )
}
