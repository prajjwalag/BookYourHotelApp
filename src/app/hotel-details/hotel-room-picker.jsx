    ...
    <article>
      {isSelected && (
        <div className='flex items-center gap-1 px-5 py-1 rounded-t-lg bg-brand'>
          <Icon icon="star" size='14' className='fill-amber-500 stroke-transparent' />
      ...
      <div className='flex border border-border p-4'>
        <div className='flex-1 space-y-4'>
          <div className='flex gap-2 items-center '>
            ...
            {isSelected && <Icon icon="circleCheck" size='26' className='fill-green-600 text-white' />}
          </div>
          <div>
      ...
      <div className='flex border-x border-b p-4 rounded-b-lg'>
        ...
        <Button size="lg" disabled={isSelected} variant='outline' className={`cursor-pointer h-12 font-semibold gap-1 w-[180px] disabled:opacity-80 uppercase ${!isSelected && 'hover:text-destructive text-destructive'}`}>
          {isSelected && <Icon icon="circleCheck" size='26' className='fill-green-600 text-white' />}
