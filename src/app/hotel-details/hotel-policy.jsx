    ...
    <div className='space-y-4'>
      <div className='flex gap-4 mx-5'>
        <div className='border-r border-border pr-4'>
          ...
          before:absolute before:size-4 before:rotate-[44deg] before:-top-2 before:left-2 before:bg-background before:border-t before:border-l before:border-border'>
